...
ckpt_to="models/uspto_radicals_fold${fold}.ckpt"
...
python -m molbart.inference_score \
  ...
  --batch_size 64 \
  --n_beams 10 \
  --output_score_data tmp/uspto_score_data_fold${fold}.csv \
  --output_sampled_smiles tmp/uspto_sampled_smiles${fold}.json
